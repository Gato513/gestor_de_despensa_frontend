...
import { fetchPurchaseReport } from "@/services/informes.service";
import { generatePurchaseReportPDF } from "./generarPDF/generatePurchaseReportPDF";
...
export const PurchaseReportModal = ({ open, handleClose }) => {
    ...
    const handleFetchReport = async () => {
        setLoading(true);
        try {
            const reportData = await fetchPurchaseReport();
            await generatePurchaseReportPDF(reportData);
