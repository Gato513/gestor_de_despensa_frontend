...
import { accessToRows, defaultFilterConfig, headOfColumns, generateDynamicInputs, bottonActionConfig } from "@/config/clientPage.config";
...
const CustomersPage = () => {
    ...
    if (user && confirmAccessRoute(user.role)) {
        const { rows: initialRows, isLoaded } = useFetchData(fetchAllCustomers);
