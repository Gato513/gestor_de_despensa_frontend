...
import { fetchAllFacturaData } from "@/services/registros.service";
import { DynamicFilter } from "@/components/filters/dynamicFilter";
import { ProgressIndicator } from "@/components/progressIndicator/progressIndicator";
import { accessToRows, defaultFilterConfig, headOfColumns, generateDynamicInputs, bottonActionConfig } from "@/config/facturasPage";
...
const FacturasPage = () => {
    ...
    if (user && confirmAccessRoute(user.role)) {
        const { rows, isLoaded } = useFetchData(fetchAllFacturaData);
