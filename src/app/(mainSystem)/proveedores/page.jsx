...
import { accessToRows, defaultFilterConfig, headOfColumns, generateDynamicInputs, bottonActionConfig } from "@/config/proveedoresPage.config";
...
const ProveedoresPage = () => {
    ...
    if (user && confirmAccessRoute(user.role)) {
        const { rows: initialRows, isLoaded } = useFetchData(fetchAllProveedores);
