...
import { accessToRows, defaultFilterConfig, headOfColumns, generateDynamicInputs } from "@/config/clientPage.config";

const CustomersPage = () => {
    const { user } = useUser();
    const { rows, isLoaded } = useFetchData(fetchAllCustomers);
