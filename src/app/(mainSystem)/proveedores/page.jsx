...
import { accessToRows, defaultFilterConfig, headOfColumns, generateDynamicInputs } from "@/config/proveedoresPage.config";

const ProveedoresPage = () => {
    const { user } = useUser();
    const { rows, isLoaded } = useFetchData(fetchAllProveedores);
