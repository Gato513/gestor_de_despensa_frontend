...
import { accessToRows, defaultFilterConfig, headOfColumns, generateDynamicInputs } from "@/config/userOfSystemPage.config";

const UserOfSystemPage = () => {
    const { user } = useUser();
    const { rows, isLoaded } = useFetchData(fetchAllUsers);
